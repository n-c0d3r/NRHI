...
"root_signature DEMO_ROOT_SIGNATURE(\n"
"	@slot(1 2)\n"
"	CONSTANTS(1)\n"
"	\n"
"	@slot(4 2)\n"
...
"	)\n"
"	\n"
"	STATIC_SAMPLER(demo_sampler_state)\n"
")\n"
"\n"
"@value_type(u32)\n"
...
"\n"
"$Buffer(float){0}\n"
"$StructuredBuffer(float4x4){1}\n"
"\n",
		"",
		E_nsl_output_language::HLSL_6_6
	);
