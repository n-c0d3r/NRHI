...
namespace nrhi {
	...
	static u32 directx11_format_aligned_stride_table[135];

	struct F_directx11_format_aligned_stride_setup {

		F_directx11_format_aligned_stride_setup() {

			memset(directx11_format_aligned_stride_table, 0xFF, sizeof(directx11_format_aligned_stride_table));

			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_UNKNOWN)] = 0;

			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_D32_FLOAT)] = 4;

			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R8G8B8A8_UNORM)] = 4;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R32_UINT)] = 4;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R32G32B32A32_FLOAT)] = 16;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R32G32B32_FLOAT)] = 16;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R32G32_FLOAT)] = 8;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R32_FLOAT)] = 4;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R16G16B16A16_FLOAT)] = 8;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R16G16_FLOAT)] = 4;
			directx11_format_aligned_stride_table[u32(DXGI_FORMAT_R16_FLOAT)] = 2;
		}
	};

	static F_directx11_format_aligned_stride_setup directx11_format_aligned_stride_setup;
	...
	u32 HD_directx11_format::aligned_stride(E_format format) {
		...
		NCPP_ASSERT(
			directx11_format_aligned_stride_table[u32(format)]
				!= 0xFFFFFFFF
		) << "non supported format";

		return directx11_format_aligned_stride_table[u32(format)];
	}
