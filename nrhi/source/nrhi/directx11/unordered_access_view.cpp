	...
	ID3D11UnorderedAccessView* F_directx11_unordered_access_view::create_d3d11_unordered_access_view(
		...
		NRHI_ENUM_SWITCH(
			...
			NRHI_ENUM_CASE(
				...
				d3d11_uav_desc.Buffer.FirstElement = desc.mem_offset / target_stride;
				d3d11_uav_desc.Buffer.NumElements = target_element_count;
				NRHI_ENUM_BREAK;
            )
			NRHI_ENUM_CASE(
			...
			NRHI_ENUM_CASE(
				...
				d3d11_uav_desc.Texture2DArray.FirstArraySlice = desc.first_array_slice;
				d3d11_uav_desc.Texture2DArray.ArraySize = target_array_size;
