...
namespace nrhi
{
    ...
    class NRHI_API HD_directx12_global_root_signature_subobject
    {
    public:
        static NCPP_FORCE_INLINE void construct_default(void* payload_p) noexcept
        {
            new(payload_p) CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT();
        }
        static NCPP_FORCE_INLINE void destruct(void* payload_p) noexcept
        {
            ((CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT*)payload_p)->~CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT();
        }
