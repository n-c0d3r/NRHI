...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_SIMPLE_RESOURCE_BINDING(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_simple_resource_binding()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_SIMPLE_RESOURCE_BINDING(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_simple_resource_binding()) { \
                __VA_ARGS__ ; \
            }
#else
...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_ADVANCED_RESOURCE_BINDING(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_advanced_resource_binding()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_ADVANCED_RESOURCE_BINDING(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_advanced_resource_binding()) { \
                __VA_ARGS__ ; \
            }
#else
...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_SIMPLE_RESOURCE_MANAGEMENT(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_simple_resource_management()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_SIMPLE_RESOURCE_MANAGEMENT(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_simple_resource_management()) { \
                __VA_ARGS__ ; \
            }
#else
...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_ADVANCED_RESOURCE_MANAGEMENT(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_advanced_resource_management()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_ADVANCED_RESOURCE_MANAGEMENT(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_advanced_resource_management()) { \
                __VA_ARGS__ ; \
            }
#else
...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_SIMPLE_WORK_SUBMISSION(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_simple_work_submission()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_SIMPLE_WORK_SUBMISSION(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_simple_work_submission()) { \
                __VA_ARGS__ ; \
            }
#else
...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_ADVANCED_WORK_SUBMISSION(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_advanced_work_submission()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_ADVANCED_WORK_SUBMISSION(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_advanced_work_submission()) { \
                __VA_ARGS__ ; \
            }
#else
...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_simple_indirect_commands()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_simple_indirect_commands()) { \
                __VA_ARGS__ ; \
            }
#else
...
#define NRHI_DRIVER_ENABLE_IF_FULL_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(nrhi::H_driver::full_support_advanced_indirect_commands()) { \
                __VA_ARGS__ ; \
            }
#define NRHI_DRIVER_DISABLE_IF_FULL_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(!nrhi::H_driver::full_support_advanced_indirect_commands()) { \
                __VA_ARGS__ ; \
            }
#else
