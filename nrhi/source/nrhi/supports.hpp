...
#else
#define NRHI_DRIVER_ENABLE_IF_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(false) { \
			}
#define NRHI_DRIVER_DISABLE_IF_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(true) { \
            	__VA_ARGS__; \
			}
#endif // NRHI_DRIVER_SUPPORT_SIMPLE_INDIRECT_COMMANDS
...
#ifdef NCPP_ENABLE_ASSERT
#define NRHI_DRIVER_REQUIRE_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) \
			NRHI_DRIVER_ENABLE_IF_SUPPORT_SIMPLE_INDIRECT_COMMANDS(__VA_ARGS__) \
			else { NCPP_ASSERT(false) << "simple indirect commands (required by this function) is not supported by current driver"; }
#else
#ifdef NRHI_DRIVER_SUPPORT_SIMPLE_INDIRECT_COMMANDS
#define NRHI_DRIVER_REQUIRE_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) __VA_ARGS__
#else
#define NRHI_DRIVER_REQUIRE_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...)
#endif
#endif
...
#ifdef NCPP_ENABLE_ASSERT
#define NRHI_DRIVER_FORBID_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) \
			NRHI_DRIVER_DISABLE_IF_SUPPORT_SIMPLE_INDIRECT_COMMANDS(__VA_ARGS__) \
			else { NCPP_ASSERT(false) << "simple indirect commands (forbidden by this function) is supported by current driver"; }
#else
#ifndef NRHI_DRIVER_SUPPORT_SIMPLE_INDIRECT_COMMANDS
#define NRHI_DRIVER_FORBID_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...) __VA_ARGS__
#else
#define NRHI_DRIVER_FORBID_SUPPORT_SIMPLE_INDIRECT_COMMANDS(...)
#endif
#endif
...
#else
#define NRHI_DRIVER_ENABLE_IF_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(false) { \
			}
#define NRHI_DRIVER_DISABLE_IF_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) NRHI_DRIVER_IF(true) { \
            	__VA_ARGS__; \
			}
...
#ifdef NCPP_ENABLE_ASSERT
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) \
			NRHI_DRIVER_ENABLE_IF_SUPPORT_ADVANCED_INDIRECT_COMMANDS(__VA_ARGS__) \
...
#ifdef NCPP_ENABLE_ASSERT
#define NRHI_DRIVER_FORBID_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) \
			NRHI_DRIVER_DISABLE_IF_SUPPORT_ADVANCED_INDIRECT_COMMANDS(__VA_ARGS__) \
			else { NCPP_ASSERT(false) << "advanced indirect commands (forbidden by this function) is supported by current driver"; }
#else
#ifndef NRHI_DRIVER_SUPPORT_ADVANCED_INDIRECT_COMMANDS
#define NRHI_DRIVER_FORBID_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) __VA_ARGS__
#else
#define NRHI_DRIVER_FORBID_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...)
#endif
#endif
...
#else
#ifdef NRHI_DRIVER_SUPPORT_ADVANCED_RESOURCE_BINDING
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_RESOURCE_BINDING(...) __VA_ARGS__
#else
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_RESOURCE_BINDING(...)
#endif
#endif
...
#else
#ifdef NRHI_DRIVER_SUPPORT_ADVANCED_RESOURCE_MANAGEMENT
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_RESOURCE_MANAGEMENT(...) __VA_ARGS__
#else
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_RESOURCE_MANAGEMENT(...)
#endif
#endif
...
#else
#ifdef NRHI_DRIVER_SUPPORT_ADVANCED_WORK_SUBMISSION
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_WORK_SUBMISSION(...) __VA_ARGS__
#else
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_WORK_SUBMISSION(...)
#endif
#endif
...
#else
#ifdef NRHI_DRIVER_SUPPORT_ADVANCED_INDIRECT_COMMANDS
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...) __VA_ARGS__
#else
#define NRHI_DRIVER_REQUIRE_SUPPORT_ADVANCED_INDIRECT_COMMANDS(...)
#endif
#endif
